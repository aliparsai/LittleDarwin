...
class ReportGenerator(object):
    ...
    def generateHTMLFinalReport(self, resultData, reportPath):
        ...
        <br/>
        <hr/> Report generated by LittleDarwin 0.0.1
        </body>
        </html>
        """
        ...
        for mutationResult in resultData:
            ...
            breakdownFile.append(
                "<tr><td><a href=\"" + os.path.relpath(os.path.join(os.path.dirname(reportPath), os.sep.join(
                    ...
                    mutationResult[0], os.path.dirname(reportPath)) + "</a></td> <td> " + ("%3.1f" % (100 - (
    ...
    def generateHTMLReportPerFile(self, filePath, reportPath, survived, killed):
        ...
        """ % os.path.relpath(filePath, os.path.dirname(reportPath))
