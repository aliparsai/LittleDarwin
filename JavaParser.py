...
#         buf.write(u"\u00b7\3\2\2\2\u0441\u0442\b]\1\2\u0442\u0443\7<\2\2")
#         buf.write(u"\u0443\u0444\5N(\2\u0444\u0445\7=\2\2\u0445\u0446\5\u00b8")
#         buf.write(u"]\24\u0446\u0450\3\2\2\2\u0447\u0448\t\b\2\2\u0448\u0450")
#         buf.write(u"\5\u00b8]\22\u0449\u044a\t\t\2\2\u044a\u0450\5\u00b8")
#         buf.write(u"]\21\u044b\u0450\5\u00ba^\2\u044c\u044d\7\"\2\2\u044d")
#         buf.write(u"\u0450\5\u00bc_\2\u044e\u0450\5\u00b0Y\2\u044f\u0441")
#         buf.write(u"\3\2\2\2\u044f\u0447\3\2\2\2\u044f\u0449\3\2\2\2\u044f")
#         buf.write(u"\u044b\3\2\2\2\u044f\u044c\3\2\2\2\u044f\u044e\3\2\2")
...
class JavaParser(Parser):
    ...
    tokenNames = [u"<INVALID>", u"'->'", u"'abstract'", u"'assert'", u"'boolean'",
    ...
    def enumBodyDeclarations(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.ABSTRACT) | (1 << self.BOOLEAN) | (
                ...
                1 << self.FINAL) | (1 << self.FLOAT) | (1 << self.INT) | (1 << self.INTERFACE) | (1 << self.LONG) | (
                1 << self.NATIVE) | (1 << self.PRIVATE) | (1 << self.PROTECTED) | (1 << self.PUBLIC) | (
                1 << self.SHORT) | (1 << self.STATIC) | (1 << self.STRICTFP) | (1 << self.SYNCHRONIZED) | (
                1 << self.TRANSIENT) | (1 << self.VOID) | (1 << self.VOLATILE) | (1 << self.LBRACE))) != 0) or (
                    (((_la - 64)) & ~0x3f) == 0 and ((1 << (_la - 64)) & (
                        (1 << (self.SEMI - 64)) | (1 << (self.LT - 64)) | (1 << (self.Identifier - 64)) | (
                1 << (self.AT - 64)))) != 0):
                self.state = 370
    ...
    def interfaceBody(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.ABSTRACT) | (1 << self.BOOLEAN) | (
                1 << self.BYTE) | (1 << self.CHAR) | (1 << self.CLASS) | (1 << self.DEFAULT) | (1 << self.DOUBLE) | (
                1 << self.ENUM) | (1 << self.FINAL) | (1 << self.FLOAT) | (1 << self.INT) | (1 << self.INTERFACE) | (
                1 << self.LONG) | (1 << self.NATIVE) | (1 << self.PRIVATE) | (1 << self.PROTECTED) | (
                1 << self.PUBLIC) | (1 << self.SHORT) | (1 << self.STATIC) | (1 << self.STRICTFP) | (
                1 << self.SYNCHRONIZED) | (1 << self.TRANSIENT) | (1 << self.VOID) | (1 << self.VOLATILE))) != 0) or (
                    (((_la - 64)) & ~0x3f) == 0 and ((1 << (_la - 64)) & (
                        (1 << (self.SEMI - 64)) | (1 << (self.LT - 64)) | (1 << (self.Identifier - 64)) | (
                1 << (self.AT - 64)))) != 0):
                self.state = 405
    ...
    def arrayInitializer(self):
        ...
        try:
            ...
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.BOOLEAN) | (1 << self.BYTE) | (1 << self.CHAR) | (
                ...
                1 << self.SHORT) | (1 << self.SUPER) | (1 << self.THIS) | (1 << self.VOID) | (
                1 << self.IntegerLiteral) | (1 << self.FloatingPointLiteral) | (1 << self.BooleanLiteral) | (
                1 << self.CharacterLiteral) | (1 << self.StringLiteral) | (1 << self.NullLiteral) | (
                1 << self.LPAREN) | (1 << self.LBRACE))) != 0) or ((((_la - 69)) & ~0x3f) == 0 and (
                (1 << (_la - 69)) & ((1 << (self.LT - 69)) | (1 << (self.BANG - 69)) | (1 << (self.TILDE - 69)) | (
                1 << (self.INC - 69)) | (1 << (self.DEC - 69)) | (1 << (self.ADD - 69)) | (1 << (self.SUB - 69)) | (
                1 << (self.Identifier - 69)))) != 0):
                self.state = 570
                self.variableInitializer()
                self.state = 575
                self._errHandler.sync(self)
    ...
    def elementValueArrayInitializer(self):
        ...
        try:
            ...
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.BOOLEAN) | (1 << self.BYTE) | (1 << self.CHAR) | (
                ...
                (1 << (_la - 69)) & ((1 << (self.LT - 69)) | (1 << (self.BANG - 69)) | (1 << (self.TILDE - 69)) | (
                1 << (self.INC - 69)) | (1 << (self.DEC - 69)) | (1 << (self.ADD - 69)) | (1 << (self.SUB - 69)) | (
                1 << (self.Identifier - 69)) | (1 << (self.AT - 69)))) != 0):
                self.state = 732
                self.elementValue()
                self.state = 737
                self._errHandler.sync(self)
    ...
    def annotationTypeBody(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.ABSTRACT) | (1 << self.BOOLEAN) | (
                ...
                1 << self.NATIVE) | (1 << self.PRIVATE) | (1 << self.PROTECTED) | (1 << self.PUBLIC) | (
                1 << self.SHORT) | (1 << self.STATIC) | (1 << self.STRICTFP) | (1 << self.SYNCHRONIZED) | (
                1 << self.TRANSIENT) | (1 << self.VOLATILE))) != 0) or ((((_la - 64)) & ~0x3f) == 0 and (
                (1 << (_la - 64)) & (
                    (1 << (self.SEMI - 64)) | (1 << (self.Identifier - 64)) | (1 << (self.AT - 64)))) != 0):
                self.state = 753
    ...
    def block(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.ABSTRACT) | (1 << self.ASSERT) | (
                ...
                1 << self.CONTINUE) | (1 << self.DO) | (1 << self.DOUBLE) | (1 << self.ENUM) | (1 << self.FINAL) | (
                1 << self.FLOAT) | (1 << self.FOR) | (1 << self.IF) | (1 << self.INT) | (1 << self.INTERFACE) | (
                1 << self.LONG) | (1 << self.NEW) | (1 << self.PRIVATE) | (1 << self.PROTECTED) | (1 << self.PUBLIC) | (
                1 << self.RETURN) | (1 << self.SHORT) | (1 << self.STATIC) | (1 << self.STRICTFP) | (
                1 << self.SUPER) | (1 << self.SWITCH) | (1 << self.SYNCHRONIZED) | (1 << self.THIS) | (
                1 << self.THROW) | (1 << self.TRY) | (1 << self.VOID) | (1 << self.WHILE) | (
                1 << self.IntegerLiteral) | (1 << self.FloatingPointLiteral) | (1 << self.BooleanLiteral) | (
                1 << self.CharacterLiteral) | (1 << self.StringLiteral) | (1 << self.NullLiteral) | (
                1 << self.LPAREN) | (1 << self.LBRACE))) != 0) or ((((_la - 64)) & ~0x3f) == 0 and (
                (1 << (_la - 64)) & ((1 << (self.SEMI - 64)) | (1 << (self.LT - 64)) | (1 << (self.BANG - 64)) | (
                1 << (self.TILDE - 64)) | (1 << (self.INC - 64)) | (1 << (self.DEC - 64)) | (1 << (self.ADD - 64)) | (
                1 << (self.SUB - 64)) | (1 << (self.Identifier - 64)) | (1 << (self.AT - 64)))) != 0):
                self.state = 809
                self.blockStatement()
                self.state = 814
                self._errHandler.sync(self)
        ...
        try:
            ...
            if la_ == 1:
                ...
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.BOOLEAN) | (1 << self.BYTE) | (
                    1 << self.CHAR) | (1 << self.DOUBLE) | (1 << self.FLOAT) | (1 << self.INT) | (1 << self.LONG) | (
                    1 << self.NEW) | (1 << self.SHORT) | (1 << self.SUPER) | (1 << self.THIS) | (1 << self.VOID) | (
                    1 << self.IntegerLiteral) | (1 << self.FloatingPointLiteral) | (1 << self.BooleanLiteral) | (
                    1 << self.CharacterLiteral) | (1 << self.StringLiteral) | (1 << self.NullLiteral) | (
                    1 << self.LPAREN))) != 0) or ((((_la - 69)) & ~0x3f) == 0 and ((1 << (_la - 69)) & (
                                            (1 << (self.LT - 69)) | (1 << (self.BANG - 69)) | (
                                        1 << (self.TILDE - 69)) | (1 << (self.INC - 69)) | (1 << (self.DEC - 69)) | (
                            1 << (self.ADD - 69)) | (1 << (self.SUB - 69)) | (1 << (self.Identifier - 69)))) != 0):
                    self.state = 913
                    self.expression(0)
        ...
        try:
            ...
            while True:
                ...
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.ABSTRACT) | (1 << self.ASSERT) | (
                    ...
                    1 << self.CONTINUE) | (1 << self.DO) | (1 << self.DOUBLE) | (1 << self.ENUM) | (1 << self.FINAL) | (
                    1 << self.FLOAT) | (1 << self.FOR) | (1 << self.IF) | (1 << self.INT) | (1 << self.INTERFACE) | (
                    1 << self.LONG) | (1 << self.NEW) | (1 << self.PRIVATE) | (1 << self.PROTECTED) | (
                    1 << self.PUBLIC) | (1 << self.RETURN) | (1 << self.SHORT) | (1 << self.STATIC) | (
                    1 << self.STRICTFP) | (1 << self.SUPER) | (1 << self.SWITCH) | (1 << self.SYNCHRONIZED) | (
                    1 << self.THIS) | (1 << self.THROW) | (1 << self.TRY) | (1 << self.VOID) | (1 << self.WHILE) | (
                    1 << self.IntegerLiteral) | (1 << self.FloatingPointLiteral) | (1 << self.BooleanLiteral) | (
                    1 << self.CharacterLiteral) | (1 << self.StringLiteral) | (1 << self.NullLiteral) | (
                    1 << self.LPAREN) | (1 << self.LBRACE))) != 0) or ((((_la - 64)) & ~0x3f) == 0 and (
                    (1 << (_la - 64)) & ((1 << (self.SEMI - 64)) | (1 << (self.LT - 64)) | (1 << (self.BANG - 64)) | (
                    1 << (self.TILDE - 64)) | (1 << (self.INC - 64)) | (1 << (self.DEC - 64)) | (
                    1 << (self.ADD - 64)) | (1 << (self.SUB - 64)) | (1 << (self.Identifier - 64)) | (
                    1 << (self.AT - 64)))) != 0)):
                    break
    ...
    def forControl(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.BOOLEAN) | (1 << self.BYTE) | (
                    1 << self.CHAR) | (1 << self.DOUBLE) | (1 << self.FINAL) | (1 << self.FLOAT) | (1 << self.INT) | (
                    1 << self.LONG) | (1 << self.NEW) | (1 << self.SHORT) | (1 << self.SUPER) | (1 << self.THIS) | (
                    1 << self.VOID) | (1 << self.IntegerLiteral) | (1 << self.FloatingPointLiteral) | (
                    1 << self.BooleanLiteral) | (1 << self.CharacterLiteral) | (1 << self.StringLiteral) | (
                    1 << self.NullLiteral) | (1 << self.LPAREN))) != 0) or ((((_la - 69)) & ~0x3f) == 0 and (
                    (1 << (_la - 69)) & ((1 << (self.LT - 69)) | (1 << (self.BANG - 69)) | (1 << (self.TILDE - 69)) | (
                    1 << (self.INC - 69)) | (1 << (self.DEC - 69)) | (1 << (self.ADD - 69)) | (1 << (self.SUB - 69)) | (
                    1 << (self.Identifier - 69)) | (1 << (self.AT - 69)))) != 0):
                    self.state = 1013
    ...
    def expression(self, _p=0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.state = 1093
                _la = self._input.LA(1)
                if not (((((_la - 80)) & ~0x3f) == 0 and ((1 << (_la - 80)) & (
                            (1 << (self.INC - 80)) | (1 << (self.DEC - 80)) | (1 << (self.ADD - 80)) | (
                    1 << (self.SUB - 80)))) != 0)):
                    self._errHandler.recoverInline(self)
                self.consume()
                self.state = 1094
                ...
                if _alt == 1:
                    ...
                    if la_ == 1:
                        ...
                        if not (((((_la - 84)) & ~0x3f) == 0 and ((1 << (_la - 84)) & (
                                (1 << (self.MUL - 84)) | (1 << (self.DIV - 84)) | (1 << (self.MOD - 84)))) != 0)):
                            self._errHandler.recoverInline(self)
                        self.consume()
                        self.state = 1105
                        self.expression(15)
                        ...
                        if not (((((_la - 68)) & ~0x3f) == 0 and ((1 << (_la - 68)) & (
                                    (1 << (self.GT - 68)) | (1 << (self.LT - 68)) | (1 << (self.LE - 68)) | (
                            1 << (self.GE - 68)))) != 0)):
                            self._errHandler.recoverInline(self)
                        self.consume()
                        self.state = 1122
                        ...
                        self.state = 1148
                        _la = self._input.LA(1)
                        if not (((((_la - 67)) & ~0x3f) == 0 and ((1 << (_la - 67)) & ((1 << (self.ASSIGN - 67)) | (
                            1 << (self.ADD_ASSIGN - 67)) | (1 << (self.SUB_ASSIGN - 67)) | (
                            1 << (self.MUL_ASSIGN - 67)) | (1 << (self.DIV_ASSIGN - 67)) | (
                            1 << (self.AND_ASSIGN - 67)) | (1 << (self.OR_ASSIGN - 67)) | (
                            1 << (self.XOR_ASSIGN - 67)) | (1 << (self.MOD_ASSIGN - 67)) | (
                            1 << (self.LSHIFT_ASSIGN - 67)) | (1 << (self.RSHIFT_ASSIGN - 67)) | (
                            1 << (self.URSHIFT_ASSIGN - 67)))) != 0)):
                            self._errHandler.recoverInline(self)
                        self.consume()
                        self.state = 1149
                        self.expression(1)
                        ...
                        if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.BOOLEAN) | (1 << self.BYTE) | (
                            ...
                            1 << self.LONG) | (1 << self.NEW) | (1 << self.SHORT) | (1 << self.SUPER) | (
                            1 << self.THIS) | (1 << self.VOID) | (1 << self.IntegerLiteral) | (
                            1 << self.FloatingPointLiteral) | (1 << self.BooleanLiteral) | (
                            1 << self.CharacterLiteral) | (1 << self.StringLiteral) | (1 << self.NullLiteral) | (
                            1 << self.LPAREN))) != 0) or ((((_la - 69)) & ~0x3f) == 0 and ((1 << (_la - 69)) & (
                                                    (1 << (self.LT - 69)) | (1 << (self.BANG - 69)) | (
                                                1 << (self.TILDE - 69)) | (1 << (self.INC - 69)) | (
                                        1 << (self.DEC - 69)) | (1 << (self.ADD - 69)) | (1 << (self.SUB - 69)) | (
                            1 << (self.Identifier - 69)))) != 0):
                            self.state = 1177
                            self.expressionList()
    ...
    def arguments(self):
        ...
        try:
            ...
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << self.BOOLEAN) | (1 << self.BYTE) | (1 << self.CHAR) | (
                ...
                1 << self.CharacterLiteral) | (1 << self.StringLiteral) | (1 << self.NullLiteral) | (
                1 << self.LPAREN))) != 0) or ((((_la - 69)) & ~0x3f) == 0 and ((1 << (_la - 69)) & (
                                        (1 << (self.LT - 69)) | (1 << (self.BANG - 69)) | (1 << (self.TILDE - 69)) | (
                                1 << (self.INC - 69)) | (1 << (self.DEC - 69)) | (1 << (self.ADD - 69)) | (
                    1 << (self.SUB - 69)) | (1 << (self.Identifier - 69)))) != 0):
                self.state = 1314
                self.expressionList()
