...
class ReportGenerator(object):
    ...
    def generateHTMLFinalReport(self, resultData, reportPath):
        ...
        reportBeginning = """
            <html>
            <head>
            <title>LittleDarwin Mutation Coverage Report</title>
            <style type='text/css'>
            table {
        ...
        <br/>
        <hr/> Report generated by LittleDarwin """ + self.littleDarwinVersion + """
        </body>
        </html>
        """
    ...
    def generateHTMLReportPerFile(self, filePath, reportPath, survived, killed):
        ...
        reportEnd = "</tbody></table><br/><hr/> Report generated by LittleDarwin " + self.littleDarwinVersion + "</body></html>"
